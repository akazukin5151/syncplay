'''This is the old version of webtorrent_mpv.py, which is just an edit of mpv.py
It has been replaced by the current webtorrent_mpv.py, which subclasses the classes in
mpv.py and so has less duplicated code. This is kept for historical and backup reasons.
Do not use.
'''
# coding:utf8
import os
...
class WebtorrentMpvPlayer(BasePlayer):
